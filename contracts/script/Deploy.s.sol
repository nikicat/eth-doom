...
contract Deploy is Script {
    ...
    function _deployMap() internal returns (Map) {
        ...
        return new Map(
            ...
            vm.parseBytes(vm.parseJsonString(j, ".blockersHex")),
            vm.parseBytes(vm.parseJsonString(j, ".pushwallsHex"))
        );
    }
    ...
    function _testRoom() internal returns (Map) {
        ...
        return new Map(w, h, tiles, 1, 1, 1, guards, "", "", "", "", ""); // single area, no blockers/pushwalls
    }
}
